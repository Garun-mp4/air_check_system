...
- графики CO₂, температуры и состояния окна за 6 часов, 24 часа или 7 дней;
...
1. **Панель** — текущий CO₂, 15-минутный прогноз, рекомендация и статус пайплайна.
2. **Управление** — вытяжка, приток, окно и состояние команд.
3. **Сенсоры** — indoor/outdoor показатели и текущее окно.
4. **История** — реальные графики из PostgreSQL.
...
- на desktop ключевой блок показаний и системный статус располагаются рядом;
